...
export const UsersTable = ({data, refetch, onSortChange}: Props) => {
    ...
    const handleSortChange = (column: SortColumn, currentSort: SortDirection | 'none') => {
        const newSort = currentSort === "none" ? SortDirection.Desc : currentSort === SortDirection.Desc ? SortDirection.Desc : SortDirection.Asc;
        ...
        <Table>
            <TableHeader>
                <TableRow>
                    ...
                    <TableCell className={s.tableHeaderCell}>Username <SortButton column={'userName'} currentSort={sortConfig["userName"] || "none"} onSortChange={handleSortChange}/></TableCell>
                    <TableCell>Profile link</TableCell>
                    <TableCell className={s.tableHeaderCell}>Date added <SortButton column={'createdAt'} currentSort={sortConfig["createdAt"] || "none"} onSortChange={handleSortChange}/></TableCell>
                    <TableCell></TableCell>
                </TableRow>
            </TableHeader>
            <TableBody>
